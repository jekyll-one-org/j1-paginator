...
<p align="center">
  <img src="https://raw.githubusercontent.com/sverrirs/j1-paginator/master/res/generator-logo.png" height="128" />
</p>
...
Don't delay, go see the [Examples](https://github.com/sverrirs/j1-paginator/tree/master/examples), they're way more useful than read-me docs at this point :)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sverrirs/j1-paginator/master/res/pagination-trails.png" />
</p>
...
{% endif %}
```
_See [example 3](https://github.com/sverrirs/j1-paginator/tree/master/examples/03-tags) for a demo of a pagination trail_
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sverrirs/j1-paginator/master/res/pagination-trails-p6.png" />
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sverrirs/j1-paginator/master/res/pagination-trails-p4-b1a3.png" />
</p>
...
This variable is created and assigned the value `page.autogen = "j1-paginator"` by the pagination logic. This way you can detect which pages are auto-generated and by what gem. 
...
For further information see [Example 4](https://github.com/sverrirs/j1-paginator/tree/master/examples/04-jsonapi), that project can serve as a starting point for your experiments with this feature.
...
> Dependency Error: Yikes! It looks like you don't have j1-paginator or one of its dependencies installed...

Check your `Gemfile` in the site root. Ensure that the j1-paginator gem is present in the jekyll_plugins group like the example below. If this group is missing add to the file.
...
> bundler/spec_set.rb:95:in `block in materialize': Could not find j1-paginator-1.0.0 in any of the sources (Bundler::GemNotFound)
